...
(function () {
  ...
  if (asideToggle && shell) {
    asideToggle.addEventListener("click", () => {
      ...
      /* Collapsing changes the content width, so the page gets shorter/taller
         while scrollY stays put. The reading-progress bar and the scroll-spy are
         only wired to scroll/resize, so without this they keep a stale value
         until the next wheel tick. Re-dispatch resize to re-sync both. */
